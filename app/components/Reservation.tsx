    ...
    <section className="reservation" id="reservierung">
      ...
      <div className="reservationCards">
        <article>
          ...
          <p>
            Hochzeitsdatum mitteilen und Verfügbarkeit prüfen lassen.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            Nach Zahlungseingang bestätigen wir euren Auftrag verbindlich.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            Die Form müsst ihr jetzt noch nicht festlegen. Wir beraten euch
            später gern.
          </p>
        </article>
      </div>
      ...
      <p className="smallNote">
        Die Reservierungsgebühr wird vollständig mit dem späteren Endpreis
        verrechnet.
      </p>
    </section>
  );
